...
class FormAddPegawaiActivity : AppCompatActivity() {
    private lateinit var binding : ActivityFormAddPegawaiBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityFormAddPegawaiBinding.inflate(layoutInflater)
